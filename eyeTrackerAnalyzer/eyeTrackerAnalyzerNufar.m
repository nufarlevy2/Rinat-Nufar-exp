...
function eyeTrackerAnalyzerNufar()
    matlab_path = fullfile('resources','matlabFiles');
    EDFs_path = fullfile('EDFs');
    ETAs_path = fullfile('resources','ETAFiles');

    convertEdfToMat(EDFs_path, matlab_path);  
