...
%                             end
                            ...
                            curr_trial_onsets = min([sacr(:,1)'; sacl(:,1)'])';                            
                            curr_trial_onsets= non_nan_times(curr_trial_onsets);
                            ...
                            donsets=diff(curr_trial_onsets);
                            maxAmp=amplitudes(1);
                            inds=[];
                            iMaxInd=1;
                            i=2;
                            ...
                            curr_trial_offsets = max([sacr(:,2)'; sacl(:,2)'])';                            
                            curr_trial_offsets= non_nan_times(curr_trial_offsets);                            
