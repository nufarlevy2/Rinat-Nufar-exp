...
% experiment's workflow: ( _EDIT_ mark
%stages needed to be edited by the programmer)
%    
...
TIME_FOR_FIXATION = 1;
NUMBER_OF_MSG_INVALID_KEY_TYPED = 10;
NUMBER_OF_MSG_INVALID_KEY_FOR_RANK_TYPED = 11;
LEFT = 0;
...
function runExp()        
    ...
    function trial_overall_i = runBlocks(conditions_mat)
        ...
        % ---------------------------------------------------------------------------------------------------
        function [trial_start_vbl, trial_end_vbl, subject_response, LeftPicRank, RightPicRank]= runTrial(trial_params)                           
