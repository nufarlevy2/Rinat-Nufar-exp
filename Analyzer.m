function Analyzer()
    ...
    END_TRIAL_TRIGGER = '4';
    START_TRIAL_TRIGGER = '2';
    
    % define data folders names
    OUTPUT_FOLDER = fullfile('outputAnalyser');
    EYE_DATA_PATH = fullfile('resources','data files','eye traching data');
    BEHAVIORAL_DATA_PATH = fullfile('resources','data files', 'Behavioral data');
